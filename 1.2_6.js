// //
// let arr=["ravi","shastry","chethan","hello",'A','B','c','z',1,2,3,4,99,101,'#','$','@']
// let words=[]
// let ch=[]
// let sp=[]
// let num=[]
...
// let fruits=["apple","grapes","mango","pinapple","orange"]
// fruits.forEach((element,index,array)=>{console.log(element,index,array)})
...
//     let{id,title,price,description,category,image,rating}=ele
    ...
    // console.log(rating)
//     if(price<100){
//         console.log(`id=${id} and price=${price}`)
//     }
// })
